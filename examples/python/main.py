"""
Example: How to call the booking-cruises-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/booking-cruises-scraper
...
def run_actor():
    """Run the booking-cruises-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/booking-cruises-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "locations": ["alaska-gulf-of-alaska"],
